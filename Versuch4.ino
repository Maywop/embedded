...
void t3Callback(){
  ...
  if ((minute<10)&&(stunde>10)){
    lcd.print((String)wochentag + stunde + ":"+ "0" + minute);
  }
  if ((stunde<10)&&(minute>10)){
    lcd.print((String)wochentag + "0" + stunde + ":"+ minute);
  }
  if ((stunde<10)&&(minute<10)){
    lcd.print((String)wochentag + "0" + stunde + ":"+ "0" + minute);
  }
 if ((stunde>=10)&&(minute>=10)){
    lcd.print((String)wochentag + stunde + ":"+ minute);
  }
}
...
void t4Callback(){
  ...
  lcd.clear();
  lcd.setCursor(0, 1);
  lcd.print((String)"Temperatur: " + temperatur);
}
...
void t5Callback(){
  ...
  if(butt == 2){
    ...
    if ((uhrtimer+10000)>millis()){
      tag += digitalRead(3);
        lcd.setCursor(0,1);
        lcd.print((String)"Tag " + (((uhrtimer+10000)-millis())/1000) + "            ");  
      if (tag>6){
        tag=0;
      }
      delay(100);
    ...
    if ((uhrtimer+20000)>millis()&& millis()>(uhrtimer+10000)){
      stunde += digitalRead(3);
              lcd.setCursor(0,1);
        lcd.print((String)"Stunde "+(((uhrtimer+20000)-millis())/1000) + "            " );  
      if (stunde>23){
        stunde=0;
      }
      delay(100);
    ...
    if ((uhrtimer+30000)>millis()&& millis()>(uhrtimer+20000)){
      minute += digitalRead(3);
          lcd.setCursor(0,1);
        lcd.print((String)"Min." + (((uhrtimer+30000)-millis())/1000) + "            ");  
      if (minute>59){
        minute=0;
      }
      delay(100);
